...
class ContratEmbauche
{
    ...
    #[Assert\NotNull(message: 'La date de debut est requise.')]
    ...
    #[Assert\Positive(message: 'Le salaire doit etre positif.')]
    ...
    #[ORM\Column(name: 'id_recrutement', type: 'integer', nullable: true)]
    ...
    public function getPeriode(): ?string
    {
        if ($this->dateDebut && $this->dateFin) {
            return $this->dateDebut->diff($this->dateFin)->format('%a jours');
        }
